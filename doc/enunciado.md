...
As RQ1–RQ3 já definidas acima são as Questions do GQM. Cabe a cada grupo escolher, dentre as métricas candidatas abaixo, quais usar para responder cada RQ — a escolha e a justificativa devem constar no Desenho do Experimento (Passo 1) e no Relatório Final.
...
**Sugestão de divisão de papéis por sprint** — não obrigatória: o trio é livre para se organizar de outra forma, desde que a regra acima seja respeitada.
